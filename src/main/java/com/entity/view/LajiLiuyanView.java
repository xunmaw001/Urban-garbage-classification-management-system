...
public class LajiLiuyanView extends LajiLiuyanEntity implements Serializable {
	...
	public LajiLiuyanView() {

	}

	public LajiLiuyanView(LajiLiuyanEntity lajiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, lajiLiuyanEntity);
